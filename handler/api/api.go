...
import (
	...
	"github.com/leonzhao/drone/handler/api/acl"
	"github.com/leonzhao/drone/handler/api/auth"
	"github.com/leonzhao/drone/handler/api/badge"
	globalbuilds "github.com/leonzhao/drone/handler/api/builds"
	"github.com/leonzhao/drone/handler/api/ccmenu"
	"github.com/leonzhao/drone/handler/api/events"
	"github.com/leonzhao/drone/handler/api/queue"
	"github.com/leonzhao/drone/handler/api/repos"
	"github.com/leonzhao/drone/handler/api/repos/builds"
	"github.com/leonzhao/drone/handler/api/repos/builds/logs"
	"github.com/leonzhao/drone/handler/api/repos/builds/stages"
	"github.com/leonzhao/drone/handler/api/repos/collabs"
	"github.com/leonzhao/drone/handler/api/repos/crons"
	"github.com/leonzhao/drone/handler/api/repos/encrypt"
	"github.com/leonzhao/drone/handler/api/repos/secrets"
	"github.com/leonzhao/drone/handler/api/repos/sign"
	globalsecrets "github.com/leonzhao/drone/handler/api/secrets"
	"github.com/leonzhao/drone/handler/api/system"
	"github.com/leonzhao/drone/handler/api/user"
	"github.com/leonzhao/drone/handler/api/users"
